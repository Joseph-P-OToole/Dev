...
public class SkillData {
    ...
    public string[] skillDescriptions = {"This is a template generator I built in Python using Tkinter, users can choose between an empty boilerplate, a canvas and animation frame boilerplate, or a full website template with many common features. It then copies the selected template to the specified directory.",
                                        "This is a game I built in vanilla Js. The object of the game is to collect gas cans while avoiding the asteroids. The rocket is being pulled toward a black hole and the user must use fuel in order to collect more.",
                                        ...
                                        "This is a logo I made using Adobe Illustrator.",
                                        ...
                                        "This is an older version of my portfolio created with React. It is a single page application that displays my skills and projects.",
